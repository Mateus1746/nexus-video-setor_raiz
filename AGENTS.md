...
8. **Recorder Command**: The CLI records videos by taking standard arguments: `node tools/Engine-Headless-Recorder/src/node/record_video.js --project=<name> --duration=<seconds> --fps=<fps> --bitrate=<bps> --canvas=<selector>`. Make sure to pass the right project name mapping to its folder context.
